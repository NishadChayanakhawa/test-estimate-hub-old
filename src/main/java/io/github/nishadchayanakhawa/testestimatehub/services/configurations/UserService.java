...
import io.github.nishadchayanakhawa.testestimatehub.repositories.configurations.UserRepository;
...
public class UserService {
	 ...
	 *             {@link io.github.nishadchayanakhawa.testestimatehub.model.dto.configurations.UserDTO
	 *             UserDTO}
	...
	/**
	 * <b>Method Name</b>: exists<br>
	 * <b>Description</b>: Validate if user exists by id.<br>
	 * 
	 * @param id as {@link java.lang.Long Long}
	 * @return true if user id exists, false otherwies.
	 */
	public boolean exists(Long id) {
		// check if user record exists by id
		boolean exists = this.userRepository.existsById(id);
		logger.debug("User for id {} exists?: {}", id, exists);
		// return flag to indicate user record existence
		return exists;
	}
	 ...
	 * <b>Description</b>: Load user by username. Required for Authentication
	 * service.<br>
	 * 
